#!/usr/bin/env python3
"""
Meeting Ingestion Bootloader v1.0
...
SKILL_NAME = "meeting-ingestion"
SKILL_DESCRIPTION = """Unified skill for ingesting meeting transcripts from Google Drive and orchestrating the processing pipeline (recap, blocks). Replaces legacy MG-1 through MG-6 agent sequence."""

# Paths this skill needs
REQUIRED_PATHS = {
    "Personal_Meetings_Inbox_": {
        "default": "Personal/Meetings/Inbox/",
        "description": "Found in SKILL.md"
    },
    "N5_review_meetings_hitl_queue": {
        "default": "N5/review/meetings/hitl-queue",
        "description": "Found in scripts/hitl.py"
    },
    "N5_config_drive_locations": {
        "default": "N5/config/drive_locations",
        "description": "Found in scripts/pull.py"
    },
    "N5_scripts": {
        "default": "N5/scripts",
        "description": "Found in scripts/pull.py"
    ...
    "N5_data_crm": {
        "default": "N5/data/crm",
        "description": "Found in scripts/crm_enricher.py"
    },
    "N5_data_profiles": {
        "default": "N5/data/profiles",
        "description": "Found in scripts/crm_enricher.py"
    },
    "Personal_Meetings_Inbox": {
        "default": "Personal/Meetings/Inbox",
        "description": "Found in scripts/archive.py"
    },
    "Personal_Meetings": {
        "default": "Personal/Meetings",
        "description": "Found in scripts/archive.py"
    },
    "Prompts_Blocks_Generate_": {
        "default": "Prompts/Blocks/Generate_",
        "description": "Found in scripts/processor.py"
    },
    "Prompts_Blocks": {
        "default": "Prompts/Blocks",
        "description": "Found in scripts/block_generator.py"
    },
    "Prompts_Blocks_BLOCK_INDEX": {
        "default": "Prompts/Blocks/BLOCK_INDEX",
        "description": "Found in scripts/block_selector.py"
    },
    "Personal_config_priorities": {
        "default": "Personal/config/priorities",
        "description": "Found in scripts/block_selector.py"
    },
    "Skills_meeting_ingestion_scripts": {
        "default": "Skills/meeting-ingestion/scripts",
        "description": "Found in scripts/process.py"
    },
    "N5_builds_meeting_skill_migration_": {
        "default": "N5/builds/meeting-skill-migration/",
        "description": "Found in references/legacy_prompts.md"
    },
    "N5_config_quality_harness": {
        "default": "N5/config/quality-harness",
        "description": "Found in references/quality-gate-docs.md"
    },
    "N5_review_meetings_": {
        "default": "N5/review/meetings/",
        "description": "Found in references/quality-harness-checks.md"
    }
}
